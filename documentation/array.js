// форич что-то делает с каждым элементом массива, метод мэп создает новые массив из старого, join соединяет массив в строку, сплайс разделяет строку на массив
